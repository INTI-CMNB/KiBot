...
def get_layers_info_pn():
    ...
    # Pad Fabrication Property
    GS.PFP_NONE = pcbnew.PAD_PROP_NONE
    GS.PFP_BGA = pcbnew.PAD_PROP_BGA
    GS.PFP_FIDUCIAL_GLBL = pcbnew.PAD_PROP_FIDUCIAL_GLBL
    GS.PFP_FIDUCIAL_LOCAL = pcbnew.PAD_PROP_FIDUCIAL_LOCAL
...
def get_layers_info_kp():
    ...
    # Pad Fabrication Property
    GS.PFP_NONE = bt2.PFP_NONE
    GS.PFP_BGA = bt2.PFP_BGA
    GS.PFP_FIDUCIAL_GLOBAL = bt2.PFP_FIDUCIAL_GLOBAL
    GS.PFP_FIDUCIAL_LOCAL = bt2.PFP_FIDUCIAL_LOCAL
    GS.PFP_TESTPOINT = bt2.PFP_TESTPOINT
    GS.PFP_HEATSINK = bt2.PFP_HEATSINK
    GS.PFP_CASTELLATED = bt2.PFP_CASTELLATED
    GS.PFP_MECHANICAL = bt2.PFP_MECHANICAL
    GS.PFP_PRESSFIT = bt2.PFP_PRESSFIT
    # Units
