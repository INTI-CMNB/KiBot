...
-  ``background_color`` :index:`: <pair: output - dxf_sch_print - options; background_color>` [:ref:`boolean <boolean>`] (default: ``false``) Use the background color from the `color_theme`.

.. _DXF_SCH_PrintOptions_color_theme:

-  ``color_theme`` :index:`: <pair: output - dxf_sch_print - options; color_theme>` [:ref:`string <string>`] (default: ``''``) Color theme used, this must exist in the KiCad config.

.. _DXF_SCH_PrintOptions_default_font:

-  ``default_font`` :index:`: <pair: output - dxf_sch_print - options; default_font>` [:ref:`string <string>`] (default: ``'KiCad Font'``) Name for the default font (KiCad 9+).
...
.. _DXF_SCH_PrintOptions_draw_hop_over:

-  ``draw_hop_over`` :index:`: <pair: output - dxf_sch_print - options; draw_hop_over>` [:ref:`boolean <boolean>`] (default: ``false``) Draw hop over at wire crossings (KiCad 10+)
