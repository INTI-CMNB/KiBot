...
.. _PS_SCH_PrintOptions_background_color:

-  ``background_color`` :index:`: <pair: output - ps_sch_print - options; background_color>` [:ref:`boolean <boolean>`] (default: ``false``) Use the background color from the `color_theme`.

.. _PS_SCH_PrintOptions_color_theme:

-  ``color_theme`` :index:`: <pair: output - ps_sch_print - options; color_theme>` [:ref:`string <string>`] (default: ``''``) Color theme used, this must exist in the KiCad config.

.. _PS_SCH_PrintOptions_default_font:

-  ``default_font`` :index:`: <pair: output - ps_sch_print - options; default_font>` [:ref:`string <string>`] (default: ``'KiCad Font'``) Name for the default font (KiCad 9+).

.. _PS_SCH_PrintOptions_dnf_filter:
...
.. _PS_SCH_PrintOptions_draw_hop_over:

-  ``draw_hop_over`` :index:`: <pair: output - ps_sch_print - options; draw_hop_over>` [:ref:`boolean <boolean>`] (default: ``false``) Draw hop over at wire crossings (KiCad 10+)
   Note that you must have a project and the hop overs enabled in the GUI.

.. _PS_SCH_PrintOptions_exclude_filter:
...
.. _PS_SCH_PrintOptions_monochrome:
...
.. _PS_SCH_PrintOptions_pre_transform:
...
.. _PS_SCH_PrintOptions_sheet_reference_layout:
...
.. _PS_SCH_PrintOptions_title_propagate:
