...
.. _Gerber_common_layers:

-  **common_layers** :index:`: <pair: output - gerber; common_layers>`  [:ref:`Layer parameters <Layer>`] [:ref:`list(dict) <list(dict)>` | :ref:`list(string) <list(string)>` | :ref:`string <string>`] (default: ``'all'``) (choices: "all", "selected", "copper", "technical", "user", "inners", "outers") (also accepts any string) List
...
- :ref:`GerberOptions parameters <GerberOptions>`
